...
function recent_post_content(){
    ...
    s += " <a href='"+feed_url+"'>";
    s += "  <img src='https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiYGJ9ep-O4aowCMmqDieS6DJCNcvlS-0FjoaGQiLQh2F2_LQJNkrTuJSAq04EMs3UPp6DVEiLtQRPBI1eAO2ICfzDA1IoVgTFApLi4mXqLG1H0Cs9TK_oeLYcV3tvcVzHkx71u7_eNFROrduYKLQ8JLun4hKTxKElJwQiU0Dw1O5gvaptX2lL-Hudl/s1600/rss.gif'";
    s += " height='25'/>";
    s += " </a>";
    s += "</div>";
